# edge-helm-chart AI Policy

AI-assisted development is welcome in edge-helm-chart.
...
A contribution is judged as a contribution to edge-helm-chart, not as AI output.
...
## AI does not relax edge-helm-chart's engineering rules
...
edge-helm-chart may be developed using interactive assistants as well as autonomous or unattended agents.
...
We welcome research involving edge-helm-chart and AI-assisted software engineering, including:
...
If an experiment produces a genuinely useful improvement to edge-helm-chart, we welcome it as a contribution.
